      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3 text-xs text-amber-300">
          ...
          <div className="flex items-center gap-1 bg-amber-900/50 px-2.5 py-1 rounded-lg border border-amber-800/40">
            ...
            <span>Patch v1.8 (Tournament Finals)</span>
          </div>
        </div>
      </div>

      <p className="text-xs text-amber-400/80 mt-3 pt-3 border-t border-amber-900/40 leading-relaxed">
        <strong>Review Methodology:</strong> Player card ratings, formation synergy and pack-pull information are compiled from public sources and community wikis; anything we could not confirm is labeled as unverified rather than estimated.
